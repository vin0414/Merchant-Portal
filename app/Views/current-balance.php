...
<head>
  ...
  <title>FastCat Merchant Portal - Balance</title>
  <!-- plugins:css -->
...
<body>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm" href="<?=site_url('payment/')?><?php echo $row->BookingNumber ?>">
                                                    <span class="mdi mdi-magnify"></span> View Details
                                                </a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                ...
                <div class="col-lg-4">
                    <div class="card card-rounded">
                        <div class="card-body">
                            ...
                            <div><sub>PHP</sub><label id="balance" style="font-size:50px;">0.00</label></div>
                        </div>
                    </div>
                    <br/>
                    <div class="card card-rounded">
                        <div class="card-body">
                            ...
                            <div><sub>PHP</sub><label id="recentExpense" style="font-size:50px;">0.00</label></div>
                        </div>
                    </div>
                </div>
            </div> 
  ...
  <script src="assets/js/Chart.roundedBarCharts.js"></script>
    <script>
        let table = new DataTable('#tblpayment');
        $(document).ready(function(){
            balance();expense();
        });
        function expense(){var user = <?php echo session()->get('merchantID') ?>;$.ajax({url:"<?=site_url('recent-expense')?>",method:"GET",data:{user:user},success:function(response){if(response==""){$('#recentExpense').html("0.00");}else{$('#recentExpense').html(response);}}});}
        function balance(){var user = <?php echo session()->get('loggedUser') ?>;$.ajax({url:"<?=site_url('get-balance')?>",method:"GET",data:{user:user},success:function(response){if(response==""){$('#balance').html("0.00");}else{$('#balance').html(response);}}});}
    </script>
</body>
